            ...
            <div className="flex-1">
                ...
                <div className="bg-white shadow p-4 flex justify-between items-center">
                    ...
                    <div className="relative">
                        <button
                            className="menu-btn bg-gray-200 px-4 py-2 rounded hover:bg-gray-300"
                            onClick={(e) => {
                                e.stopPropagation();
                        ...
                        {openMenu && (
                            <div
                                className="menu-panel absolute right-0 mt-2 w-40 bg-white shadow-lg rounded border"
